...
class ListaEnviosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val listaEnvios = listOf(
            Envios("12345", "Calle Falsa 123, Ciudad XYZ", "Calle principal, 123","En transito", listOf("Lista"), cliente = Clientes("Juan","2311172215", "juan@example.com")),
        ...
        binding.recyclerViewEnvios.adapter = EnvioAdapter(listaEnvios)
